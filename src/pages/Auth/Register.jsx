    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .anim-7 { animation: fadeUp 0.9s cubic-bezier(0.16,1,0.3,1) 0.70s both; }
        .anim-8 { animation: fadeUp 0.9s cubic-bezier(0.16,1,0.3,1) 0.77s both; }
        ...
        .login-link:hover { opacity: 0.55; border-color: transparent; }
      ...
      <div style={{ display: 'flex', height: '100vh', width: '100vw', background: '#080808', overflow: 'hidden', fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 44px', background: '#080808', overflow: 'hidden' }}>
          ...
          <div style={{ width: '100%', maxWidth: '340px', position: 'relative', zIndex: 1 }}>
            ...
            {/* Logo */}
            <div className="anim-1" style={{ textAlign: 'center', marginBottom: '36px' }}>
              <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '56px', fontWeight: 300, color: '#fff', letterSpacing: '0.16em', lineHeight: 1 }}>Sphere</h1>
            ...
            {/* Heading */}
            <div className="anim-2" style={{ textAlign: 'center', marginBottom: '26px' }}>
              <h2 style={{ color: '#fff', fontSize: '22px', fontWeight: 600, letterSpacing: '-0.02em', fontFamily: "'DM Sans', sans-serif" }}>Create your account</h2>
              <p style={{ color: 'rgba(255,255,255,0.22)', fontSize: '13px', marginTop: '8px', fontFamily: "'DM Sans', sans-serif" }}>Join the community today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div className="anim-3">
                ...
                <input type="text" name="username" value={form.username} onChange={handleChange} className="glass-input" placeholder="Choose a username" required />
              </div>
              ...
              <div className="anim-5">
                ...
                <div style={{ position: 'relative' }}>
                  <input type={showPassword ? 'text' : 'password'} name="password" value={form.password} onChange={handleChange} className="glass-input" style={{ paddingRight: '44px' }} placeholder="Choose a password" required />
              ...
              <div className="anim-6" style={{ paddingTop: '4px' }}>
            ...
            {/* Divider */}
            <div className="anim-7" style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '20px 0' }}>
            ...
            {/* Sign in link */}
            <p className="anim-8" style={{ color: 'rgba(255,255,255,0.2)', fontSize: '12px', textAlign: 'center', marginTop: '22px', fontFamily: "'DM Sans', sans-serif" }}>
