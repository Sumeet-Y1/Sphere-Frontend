    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Right edge bleed into form — no hard line */}
          <div style={{
          ...
          {/* Cinematic caption — different quote from Login */}
        ...
        <div style={{
          ...
          <div style={{ width: '100%', maxWidth: '340px', position: 'relative', zIndex: 1 }}>
            ...
            {/* Logo */}
            <div className="anim-1" style={{ textAlign: 'center', marginBottom: '44px' }}>
              <h1 style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: '56px',
                fontWeight: 300,
            ...
            {/* Heading */}
            <div className="anim-2" style={{ textAlign: 'center', marginBottom: '30px' }}>
              <h2 style={{
                color: '#fff',
                fontSize: '22px',
                fontWeight: 600,
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              ...
              <div className="anim-6" style={{ paddingTop: '6px' }}>
